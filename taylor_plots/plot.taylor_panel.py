...
for iplot,varnames in enumerate(varlist):
    ...
    for ivar,varname in enumerate(varnames):
        ...
        cntl_data = get_data(cntl_inptr,varname)
        cntl_lat = cntl_inptr.variables['lat'].getValue()
        cntl_lon = cntl_inptr.variables['lon'].getValue()
