...
model_dir = '/home/jonahks/drivemount/mnth15runs/20191122_161009_sample_param_set_wbf1_inp1/'
output_dir = '/home/jonahks/drivemount/figures/'


# To-do related to mounting/unmounting the right drive
...
save = False
if save is True: # Overwrite
    test_fig.savefig(save_to + filename,format = 'png', dpi = 200)
